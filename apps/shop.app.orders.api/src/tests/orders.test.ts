...
import { fetchDocuments, fetchDocument, updateDocument } from '@shop.app/lib.server-utils/dist/mongodb';
import { v4 as uuidv4 } from 'uuid';
import { getObject, updateObject } from '@shop.app/lib.server-utils/dist/cache';
...
jest.mock('@shop.app/lib.server-utils/dist/cache', () => ({
  getObject: jest.fn(),
